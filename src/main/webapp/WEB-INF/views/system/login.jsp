...
<head>
	...
	<link rel="stylesheet" href="${path}/res/css/login.css" media="all" />
</head>

<body class="beg-login-bg">
	<div class="beg-login-box">
		<header>
			<h1>在线考试题库管理系统后台登录</h1>
		</header>
		<div class="beg-login-main">
			<form action="" class="layui-form" method="post">
				...
				<div class="layui-form-item">
					...
					<input type="text" name="name" lay-verify="required" autocomplete="off" placeholder="这里输入登录名"
						class="layui-input">
				</div>
				<div class="layui-form-item">
					<label class="beg-login-icon">
					...
					<input type="password" name="pwd" required lay-verify="required|password" autocomplete="off"
